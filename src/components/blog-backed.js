      ...
      <article className={blogStyles.blogItem}>
        ...
        <div className={blogStyles.content}>
          ...
          <p>
            ...
            adipisicing exercitation ex. Anim cupidatat esse aute laboris est.
            Reprehenderit mollit laborum cillum irure laborum ad excepteur
            minim. Ullamco exercitation ea nisi velit pariatur laborum nulla
            fugiat.{" "}
          </p>
          <a href="#">Read More</a>
        </div>
