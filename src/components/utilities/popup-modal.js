    ...
    <div className={popupModalStyles.modal} id="test-view" aria-hidden="true">
      <div className={popupModalStyles.modalDialog}>
        <div className={popupModalStyles.modalHeader}>
          ...
          <a href="#test-view" className={popupModalStyles.btnClose} aria-hidden="true">
            ×
          </a>
        </div>
        <div className={popupModalStyles.modalBody}>
          <p>Hi everyone welcome to Ajeet Chaulagain's personal site. The site is in progress at the moment to bring some major updates. There are some dummy content populated for now. 
          </p>
          <p>Sorry for the inconvenience created. You can still browse the site!</p>
        </div>
