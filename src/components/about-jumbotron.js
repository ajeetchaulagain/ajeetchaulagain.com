...
const AboutJumbotronBlog = () =>{
    ...
    return (
        <div className={jumbotronStyles.wrapper}>
            ...
            <p>I am Ajeet Chaulagain, a full stack developer based on Melbourne, Australia.
             I write about the <em>development and about my side projects</em> to inspire begineer
             start there career in software engineering. If my site has helped you somehow, It would be grateful if you consider supporting me.
             </p>
            </div>
        </div>
    )
